...
from docparser.detection_filter import FilteredElement, filter_elements, find_nearby_context_elements
from docparser.detectors import DocLayoutYOLODetector, FullPageFallbackDetector, PdfiumTextRectDetector, crop_element_image
from docparser.layout_order import infer_reading_order
from docparser.markdown_writer import MarkdownWriter
from docparser.metadata import generate_metadata_json
from docparser.ocr_vlm import DEFAULT_VLM_PROMPT, OCRTask, TaskExecutor, VLMTask
from docparser.pdf_render import PageAsset, render_pdf_pages
...
from docparser.quality_check import page_quality
from docparser.text_clean import clean_deepseek_ocr_text, is_likely_ocr_hallucination
...
def parse(
    ...
    # OpenAI / vLLM
    openai_api_key: str | None = typer.Option(None, "--openai-api-key", help="OpenAI API Key (or set OPENAI_API_KEY)"),
    openai_base_url: str | None = typer.Option(None, "--openai-base-url", help="OpenAI Base URL (e.g. for vLLM)"),
    openai_ocr_model: str = typer.Option("deepseek-ocr", "--openai-ocr-model", help="OpenAI OCR model name"),
    openai_vlm_model: str = typer.Option("gpt-4o-mini", "--openai-vlm-model", help="OpenAI VLM model name"),
    openai_timeout_sec: int = typer.Option(600, "--openai-timeout-sec"),
    ...
    run_parse(
        ...
        yolo_from_pretrained=yolo_from_pretrained,
        yolo_pretrained_filename=yolo_pretrained_filename,
        yolo_dump_labels=yolo_dump_labels,
        save_detections=save_detections,
        detections_image_format=detections_image_format,
        detections_jpeg_quality=detections_jpeg_quality,
        ocr_provider=ocr_provider,
        ocr_scope=ocr_scope,
        ocr_mode=ocr_mode,
        ocr_elements_mode=ocr_elements_mode,
        vlm_provider=vlm_provider,
        vlm_scope=vlm_scope,
        vlm_use_image=vlm_use_image,
        vlm_think=vlm_think,
        vlm_temperature=vlm_temperature,
        vlm_repeat_penalty=vlm_repeat_penalty,
        vlm_num_predict=vlm_num_predict,
        ...
        openai_vlm_model=openai_vlm_model,
...
def run_parse(
    ...
    yolo_from_pretrained: bool = False,
    yolo_pretrained_filename: str = "doclayout_yolo_docstructbench_imgsz1024.pt",
    yolo_dump_labels: bool = False,
    
    # Detection Output
    save_detections: bool = False,
    detections_image_format: str = "jpg",
    detections_jpeg_quality: int = 85,
    
    # OCR
    ocr_provider: str = "none",
    ocr_scope: str = "page",
    ocr_mode: str = "markdown",
    ocr_elements_mode: str = "auto",
    
    # VLM
    vlm_provider: str = "none",
    vlm_scope: str = "none",
    vlm_use_image: bool = False,
    vlm_think: bool = False,
    vlm_temperature: float = 0.1,
    vlm_repeat_penalty: float = 1.2,
    vlm_num_predict: int = 350,
    
    # Ollama
    ollama_model: str = "deepseek-ocr:latest",
    ollama_vlm_model: str = "gemma3:27b",
    ollama_host: str = "",
    ollama_transport: str = "api",
    ollama_timeout_sec: int = 600,
    
    # OpenAI / vLLM
    openai_api_key: str | None = None,
    openai_base_url: str | None = None,
    openai_ocr_model: str = "deepseek-ocr",
    openai_vlm_model: str = "gpt-4o-mini",
    openai_timeout_sec: int = 600,
    
    # Figure Processing
    figure_ocr: bool = True,
    figure_vlm: bool = True,
    ...
    ocr, vlm = _create_providers(
        ...
        # OpenAI Options
        openai_api_key, openai_base_url, openai_ocr_model, openai_vlm_model, openai_timeout_sec
    )
